...
# He claims: Need to call git with manually specified paths to repository
#BASE_GIT_COMMAND = git --git-dir $$PWD/.git --work-tree $$PWD
# But you are good and only run this in the src folder, right?
BASE_GIT_COMMAND = git

# Trying to get version from git tag / revision
GIT_VERSION = $$system($$BASE_GIT_COMMAND describe --always --tags 2> $$NULL_DEVICE)
message(raw output $$GIT_VERSION)
